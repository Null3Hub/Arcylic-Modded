...
$requireReplacements = [ordered]@{
    ...
    'require(script.Parent.Parent.Utils.ConfigEncryption)' = '__require("Utils.ConfigEncryption")'
    'require(script.Parent.Parent.Utils.RandomString)' = '__require("Utils.RandomString")'
